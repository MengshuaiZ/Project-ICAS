...
theta_sense = 12.3;   % pointing direction of sensing beam
...
W = w_t_opt1;  % used in plotting fig.9
...
plot(angle, 10*log10(abs(r_1(:, 3))), '--','color',[0.5, 0, 0.8],'Marker','p','MarkerIndices',1:20:1200);
...
plot(angle, 10*log10(abs(r_5(:, 4))), '--','color',[0.5, 0, 0.8],'Marker','p','MarkerIndices',1:20:1200);
...
% plot(angle, 10*log10(abs(r_4(:, 2))), 'c-.');
plot(angle, 10*log10(abs(r_4(:, 3))), '--','color',[0.5, 0, 0.8],'Marker','p','MarkerIndices',1:20:1200);
% plot(angle, 10*log10(abs(r_4(:, 4))), '--','color',[0.5, 0, 0.8],'Marker','o','MarkerIndices',1:20:1200);
xlabel('Scanning direction in Degrees');
ylabel('BF radiation pattern(dB)');
% legend('Without quantization','bit=2','bit=3','bit=4','bit=5');
